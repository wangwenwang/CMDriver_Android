 ...
 */
public class OpInstructionActivity extends BaseActivity {
    private final String DEFAULT_URL = "http://www.chengma.co/business.aspx";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleView.setText(getString(R.string.operating_instructions));
